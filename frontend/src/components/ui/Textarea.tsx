  ...
  return (
    <div className="space-y-1.5">
      ...
      <textarea
        id={areaId}
        className={cn(
          'w-full min-h-[100px] px-3 py-2.5 rounded-[10px] border border-border bg-elevated text-sm text-text placeholder:text-text-secondary/70 scheme-light dark:scheme-dark',
